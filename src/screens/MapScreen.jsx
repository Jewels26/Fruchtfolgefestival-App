...
const AREAS = [
  {
    ...
    height: 834,
    markers: [
      { num: 2, name: 'Bühne', x: 548, y: 203 },
      { num: 3, name: 'Festivalbar', x: 462, y: 483 },
      { num: 4, name: 'Feldküche', x: 340, y: 378 },
      { num: 5, name: 'Erste Hilfe', x: 655, y: 558, danger: true },
      { num: 6, name: 'Toiletten Festivalgelände', x: 1068, y: 378 },
      { num: 9, name: 'Chillout-Bereich', x: 770, y: 278 },
      { num: 11, name: 'Zanzibar', x: 963, y: 520 },
      { num: 13, name: 'Zauberzelt', x: 813, y: 558 },
      { num: 10, name: 'Fundsachen', x: 580, y: 628 },
      { num: 12, name: 'Merch', x: 690, y: 628 },
    ],
  },
  {
    key: 'campground',
    ...
    height: 741,
    markers: [
      { num: 8, name: 'Duschen / Spa-Bereich', x: 585, y: 125 },
      { num: 7, name: 'Toiletten Campingplatz', x: 275, y: 245 },
      { num: 1, name: 'Einlass Festivalgelände', x: 860, y: 250 },
      { num: 14, id: 'campingflaeche-1', name: 'Campingflächen', x: 570, y: 260 },
      { num: 14, id: 'campingflaeche-2', name: 'Campingflächen', x: 695, y: 525 },
      { num: 15, name: 'Parkplatz', x: 180, y: 490 },
    ],
  },
]
